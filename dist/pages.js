        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    lastPageLink = $('.page-number ul li a').eq(-2).attr('href');
                    if (!lastPageLink) {
                        throw new Error('Could not find the last page link');
                    }
                    lastPageMatch = lastPageLink.match(/page=(\d+)/);
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error getting the last page:', error_1);
                    throw error_1;
...
function getDocLinksFromPage(link) {
    return __awaiter(this, void 0, void 0, function () {
        var response, $_1, docLinks_1, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                ...
                case 1:
                    ...
                    $_1('a.doc-link').each(function (index, element) {
                        var href = $_1(element).attr('href');
                        if (href) {
                            docLinks_1.push(href);
                        }
                    });
                    return [2 /*return*/, docLinks_1];
                case 2:
                    error_2 = _a.sent();
                    console.error('Error getting document links:', error_2);
                    throw error_2;
                case 3: return [2 /*return*/];
            }
        });
